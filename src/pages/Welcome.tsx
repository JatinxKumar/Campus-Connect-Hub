    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="z-10 text-center px-4 max-w-4xl mx-auto flex flex-col items-center smooth-in">
        ...
        <h1 className="text-5xl md:text-7xl lg:text-8xl font-extrabold mb-6 leading-[1.1] text-foreground tracking-tight">
          Welcome to <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-accent">ClubHub</span>
        </h1>
        
        <p className="text-xl md:text-2xl mb-12 text-muted-foreground max-w-2xl leading-relaxed">
          The ultimate college club management system. Please tell us how you want to use the platform.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full max-w-2xl px-4">
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h2 className="text-2xl font-bold text-foreground">I am a Student</h2>
              <p className="text-muted-foreground">
                Join clubs, discover events, and connect with your peers across campus.
              </p>
            </div>
          </button>
          ...
          >
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <h2 className="text-2xl font-bold text-foreground">I am an Admin</h2>
              <p className="text-muted-foreground">
                Create new clubs, manage events, and curate the campus community.
              </p>
            </div>
          </button>
        </div>
